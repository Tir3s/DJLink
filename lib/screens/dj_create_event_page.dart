...
class DjCreateEventPage extends StatefulWidget {
  const DjCreateEventPage({super.key});

  @override
  State<DjCreateEventPage> createState() => _DjCreateEventPageState();
}

class _DjCreateEventPageState extends State<DjCreateEventPage> {
  ...
  Future<void> _createEvent() async {
    ...
    try {
      ...
      AppSession.selectedEvent = EventSummary(
        ...
        time: _buildDisplayTime(),
        isLive: false,
      );
      _showSnack('Event created. Join code: $eventId');
